<template>
    <div>
        ...
        position: absolute; left: 700px; top: 8px; color: #f3eeee;">我参与的投票</span>
        <i class="el-icon-s-custom" style="float: left; z-index: 999; font-size: xx-large; color: #eae2e2;
      position: absolute; left: 1230px; top: 30px;"></i>
...
export default {
    methods: {
        ...
        deleteMyVote: function (val) {
            ...
            this.$confirm('是否要撤回该投票', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(() => {
                axios.delete("http://localhost:8080/vote/deleteMyParticipate", {
                    params: {
                        title: this.title,
        ...
        search: function () {
            // alert(this.input);
            axios.get("http://localhost:8080/vote/searchMyParticipate", {
                params: {
                    content: this.input,
                    username: this.username,
                }
    ...
    mounted: function () {
        ...
        axios.get("http://localhost:8080/vote/myParticipate", {
            params: {
                id: this.username,
            }
        })
